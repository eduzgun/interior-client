    ...
    return (
      <div id='home-container'>
        <div id='left-content'>
          ...
          <div class="text-section">
            <h3>About us</h3>
            <p>At Inspire My Space, we are passionate about transforming the way you envision and create your living spaces. Our revolutionary interior design application is meticulously crafted to empower both individuals and professional interior designers. With our visually engaging platform, we provide the inspiration and tools you need to bring your design visions to life. Join us on a journey where creativity meets functionality, and let Inspire My Space elevate your interior design experience.</p>
          </div>
          <div class="text-section">
            <h3>Demo</h3>
